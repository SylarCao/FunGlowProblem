...
static NSString * const endIndexKey = @"endIndexKey";
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
@property (atomic, strong) NSMutableArray *frames;  // already exist frames
...
@implementation MethodThread4 {
    ...
    pthread_mutex_t _move;
    pthread_mutex_t _framesLock;
}
